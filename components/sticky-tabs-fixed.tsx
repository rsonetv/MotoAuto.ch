    ...
    >
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="bg-secondary/20 min-h-screen"
        >
            ...
            {activeTab === "aukcje" ? (
              <div className="text-center py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {[1, 2, 3].map((index) => (
                    <div key={index} className="bg-white dark:bg-card rounded-lg shadow-sm p-4">
                      <div className="aspect-video bg-secondary/40 rounded mb-4"></div>
