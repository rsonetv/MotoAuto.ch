...
export function LoginForm() {
  ...
  const handleGoogleLogin = async () => {
    ...
    toast.info("Logowanie przez Google będzie dostępne wkrótce")
  }
    ...
    <Card className="w-full max-w-md mx-auto">
      ...
      <CardContent>
        ...
        <div className="mt-4">
          ...
          <Button type="button" variant="outline" className="w-full mt-4 bg-transparent" onClick={handleGoogleLogin}>
